...
<div id="sideMenu" class="shadow-sm bg-white">
    <div class="d-flex flex-column py-5">
         <a href="Dashboard.php" class="w-100 py-1 px-3 d-flex align-items-center">
             <img class="opacity-75" src="../Img/Icon/dashboard.png" alt="">
             <p class="text-gray ms-3">Dashboard</p>
         </a>
         <a href="Product.php?CategoryID=All" class="w-100 py-1 px-3 d-flex align-items-center">
             <img class="opacity-75" src="../Img/Icon/shop.png" alt="">
             <p class="text-gray ms-3">Product</p>
         </a>
         <a href="Order.php" class="w-100 py-1 px-3 d-flex align-items-center">
             <img class="opacity-75" src="../Img/Icon/orderHistory.png" alt="">
             <p class="text-gray ms-3">Order</p>
         </a>
         <a href="Customer.php" class="w-100 py-1 px-3 d-flex align-items-center">
             <img class="opacity-75" src="../Img/Icon/customer.png" alt="">
             <p class="text-gray ms-3">Customer</p>
         </a>
<!--         <a href="" class="w-100 py-1 px-3 d-flex align-items-center">
             <img class="opacity-75" src="../Img/Icon/staff.png" alt="">
             <p class="text-gray ms-3">Staff</p>
         </a>-->
         <a href="Profile.php" class="w-100 py-1 px-3 d-flex align-items-center">
...
<!--         <a href="" class="w-100 py-1 px-3 d-flex align-items-center">
    ...
    <footer class="text-center">
         <small class="text-gray">&copy; 2025 A-PLUS Sdn Bhd</small>
    </footer>
 </div>